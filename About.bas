...
Sub Activity_Create(FirstTime As Boolean)
	...
	lblName.Text = "Myanmar Font Changer"
	lblName.TextSize = 13
	...
	lstOne.AddSingleLine2("App Name : Myanmar Font Changer",1)
	lstOne.AddSingleLine2("Version : 1.0",2)
	lstOne.AddSingleLine2 ("Font Developer : Kyaw Swar Thwin   ", 3)

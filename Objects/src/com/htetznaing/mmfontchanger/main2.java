...
public class main2 extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.main2");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.main2");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmfontchanger.main2", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._b6.Initialize(mostCurrent.activityBA,"b6");
 //BA.debugLineNum = 70;BA.debugLine="b6.Text = \"All Android [#Root]\"";
mostCurrent._b6.setText((Object)("All Android [#Root]"));
...
mostCurrent._sm._additem("Xiaomi",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"xiaomi.png"),(Object)(5));
 //BA.debugLineNum = 90;BA.debugLine="sm.AddItem(\"All Android [#Root]\",LoadBitmap(File.";

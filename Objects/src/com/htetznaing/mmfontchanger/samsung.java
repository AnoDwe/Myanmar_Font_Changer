...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmfontchanger.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 30;BA.debugLine="lb.Text = \"	Install ကိုနွိပ္ျပီး Myanmar(iFont) က";
...
mostCurrent._sm._additem("Xiaomi",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"xiaomi.png"),(Object)(5));
 //BA.debugLineNum = 81;BA.debugLine="sm.AddItem(\"All Android [#Root]\",LoadBitmap(File.";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 122;BA.debugLine="File.Copy(File.DirAssets,\"Myanmar.apk\",File.DirRo";
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 131;BA.debugLine="If File.Exists(File.DirRootExternal,\"Myanmar.apk\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 132;BA.debugLine="File.Delete(File.DirRootExternal,\"Myanmar.apk\")";
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 147;BA.debugLine="If File.Exists(File.DirRootExternal,\"Myanmar.apk\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 148;BA.debugLine="File.Delete(File.DirRootExternal,\"Myanmar.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk");
 };
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 215;BA.debugLine="copy.setText(\"#MyanmarFontChanger App! You can Us";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 193;BA.debugLine="copy.setText(\"#MyanmarFontChanger App! You can";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarFontChanger App! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Font+Changer");

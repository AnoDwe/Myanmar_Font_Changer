...
public class other extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.other");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.other");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmfontchanger.other", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 111;BA.debugLine="tlb.Text = \"All Android [#Root]\"";
mostCurrent._tlb.setText((Object)("All Android [#Root]"));
...
mostCurrent._sm._additem("Xiaomi",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"xiaomi.png"),(Object)(5));
 //BA.debugLineNum = 126;BA.debugLine="sm.AddItem(\"All Android [#Root]\",LoadBitmap(File.";
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 179;BA.debugLine="File.Copy(File.DirAssets,\"Myanmar.ttf\",File.DirR";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Myanmar.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeart.ttf");
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 638;BA.debugLine="copy.setText(\"#MyanmarFontChanger App! You can Us";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 616;BA.debugLine="copy.setText(\"#MyanmarFontChanger App! You can";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarFontChanger App! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Font+Changer");

...
public class oppo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.oppo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.oppo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmfontchanger.oppo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 29;BA.debugLine="lb.Text = \"Install ကိုနွိပ္ျပီး Myanmar(iFont) ကိ";
mostCurrent._lb.setText((Object)("Install ကိုနွိပ္ျပီး Myanmar(iFont) ကို Install လုပ္ေပးလိုက္ပါ။  Install လုပ္လို့ၿပီးရင္ Done ကိုသာနွိပ္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar(iFont) ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"));
...
mostCurrent._sm._additem("Xiaomi",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"xiaomi.png"),(Object)(5));
 //BA.debugLineNum = 80;BA.debugLine="sm.AddItem(\"All Android [#Root]\",LoadBitmap(File.";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="File.Copy(File.DirAssets,\"Myanmar.apk\",File.DirRo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Myanmar.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk");
...
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Myanmar.apk");
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 130;BA.debugLine="If File.Exists(File.DirRootExternal,\"Myanmar.apk\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="File.Delete(File.DirRootExternal,\"Myanmar.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk");
 };
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="If File.Exists(File.DirRootExternal,\"Myanmar.apk\"";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 147;BA.debugLine="File.Delete(File.DirRootExternal,\"Myanmar.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Myanmar.apk");
 };
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 214;BA.debugLine="copy.setText(\"#MyanmarFontChanger App! You can Us";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 192;BA.debugLine="copy.setText(\"#MyanmarFontChanger App! You can";
mostCurrent._copy.setText(mostCurrent.activityBA,"#MyanmarFontChanger App! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Font+Changer");

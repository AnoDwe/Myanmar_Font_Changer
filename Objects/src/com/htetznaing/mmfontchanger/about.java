...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmfontchanger", "com.htetznaing.mmfontchanger.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmfontchanger.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_lblname.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 46;BA.debugLine="lblName.Text = \"Myanmar Font Changer\"";
_lblname.setText((Object)("Myanmar Font Changer"));
...
mostCurrent._lstone.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 61;BA.debugLine="lstOne.AddSingleLine2(\"App Name : Myanmar Font Ch";
mostCurrent._lstone.AddSingleLine2("App Name : Myanmar Font Changer",(Object)(1));
...
mostCurrent._lstone.AddSingleLine2("Version : 1.0",(Object)(2));
 //BA.debugLineNum = 63;BA.debugLine="lstOne.AddSingleLine2 (\"Font Developer : Kyaw Swa";
mostCurrent._lstone.AddSingleLine2("Font Developer : Kyaw Swar Thwin   ",(Object)(3));
...
mostCurrent._lstone.AddSingleLine2("Powered By : Myanmar Android App",(Object)(5));
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 80;BA.debugLine="tlb.Text = \"Myanmar Font Changer\"";
...
mostCurrent._sm._additem("Xiaomi",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"xiaomi.png"),(Object)(5));
 //BA.debugLineNum = 95;BA.debugLine="sm.AddItem(\"All Android [#Root]\",LoadBitmap(File.";
...
public static String  _lbname_click() throws Exception{
 ...
 //BA.debugLineNum = 153;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.MyanmarAn";

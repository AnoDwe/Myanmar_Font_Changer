...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "	Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font1 ကိုနွိပ္ပါ Myanmar.txj (သို့) Myanmar.itz ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ မရခဲ့ရင္ Change Font2 ကိုနွိပ္ျပီး Myanmar နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
	...
	sm.AddItem("All Android [#Root]",LoadBitmap(File.DirAssets,"Other.png"),6)
	...
	Banner.Initialize2("Banner","ca-app-pub-4173348573252986/3392987752",Banner.SIZE_SMART_BANNER)
	Dim height As Int
	...
	Interstitial.Initialize("Interstitial","ca-app-pub-4173348573252986/4730120158")
	Interstitial.LoadAd
...
Sub b2_Click
	...
	Catch
		...
		b1.Visible=False
		b2.Visible=False
		msg.Text = "File Manager တစ္ခုခုထဲသို႔သြားၿပီး Vivo Myanmar Font ဖိုဒါထဲကိုဝင္ပါ။ Myanmar.txj (သို့) Myanmar.itz ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ သို႔မဟုတ္ Change Font2 နဲ႔ထပ္သြင္းပါ။"
		ad1.Enabled =True
	End Try
End Sub
...
Sub b3_Click
	...
	b1.Visible=False
	b2.Visible=False
	msg.Text = "Install ကိုႏွိပ္ၿပီးတာနဲ႔ ဖုန္းမွာ Default File Manager တစ္ခုခုမေရြးထားရင္ေတာ့ ကိုယ့္ဘာသာကို ဖုန္းထဲက File Manager တစ္ခုခုထဲကိုသြားလိုက္ပါ။	ၿပီးရင္ Vivo Myanmar Font ဆိုတဲ့ဖိုဒါကိုရွာၿပီး ဝင္လိုက္ပါ။ အဲ့ဖိုဒါထဲမွာ Myanmar.txj (သို့) Myanmar.itz ဆိုတဲ့ဖိုင္ေလးကိုဖြင့္ၿပီး Apply ေပးလိုက္ပါ။ အဆင္မေျပတာမ်ားရွိရင္ Facebook က Myanmar Android App မွာလာေမးနိုင္ပါတယ္ :)"
	ad1.Enabled = True
End Sub
...
Sub SlideMenu_Click(Item As Object)
	...
	Select Item
		...
		Case 7 :
			...
			copy.clrText
			copy.setText("#MyanmarFontChanger App! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Font+Changer")
